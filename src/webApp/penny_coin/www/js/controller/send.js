...
.controller('AbstractSendCtrl', function($scope, $rootScope, 
  $filter, $state, $ionicLoading, $ionicPopup, $stateParams, 
  Config, Rates, Notifications, Addresses, Bitcore, PayPro) {
