...
.controller('AbstractModalCtrl', 
  function($scope, $ionicModal, $window, $cordovaSocialSharing, 
    $cordovaClipboard, Notifications) {

  $scope.modal = {};
  $ionicModal.fromTemplateUrl('views/qr.html', {
    scope: $scope,
